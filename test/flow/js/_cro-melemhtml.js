...
/******/ 	return __webpack_require__(__webpack_require__.s = "./test/flow/melemhtml.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _src_ToolBar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../src/ToolBar */ "./src/ToolBar.ts");
/**
 * 工作流程编辑器
 */
...
$(function(){
    ...
    new class App{
        ...
        title(){
            let version = _src_WorkerEditor__WEBPACK_IMPORTED_MODULE_0__["default"].version
            $('.srroo-top').text(`
        ...
        clipBoard(){
            ...
            document.addEventListener('paste', (e) => {
                ...
                if(str){
                    try {
                        ...
                        if(rs.name == _src_WorkerEditor__WEBPACK_IMPORTED_MODULE_0__["default"].version.name){
            ...
            document.addEventListener('copy', (e) => {
                ...
                if(data.length > 0){
                    var rs = {data, name: _src_WorkerEditor__WEBPACK_IMPORTED_MODULE_0__["default"].version.name}
...
/******/ });
//# sourceMappingURL=_cro-melemhtml.js.map