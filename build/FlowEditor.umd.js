...
})(window, function(__WEBPACK_EXTERNAL_MODULE_raphael__) {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/browser.FlowEditor.umd.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _confNode__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./confNode */ "./src/confNode.ts");
...
var ToolBar = /** @class */ (function () {
    ...
    ToolBar.prototype._drawCCNodes = function () {
        ...
        x += w / 2;
        _util__WEBPACK_IMPORTED_MODULE_1__["Util"].each(menuSeting, function (mk, row) {
            if ('object' != typeof row) {
                mk = row;
                row = {};
            }
            if (!_confNode__WEBPACK_IMPORTED_MODULE_2__["cNode"][mk]) {
                return;
            }
            // console.log(mk)
            y += 32;
            var text = row.text || _confNode__WEBPACK_IMPORTED_MODULE_2__["cNode"][mk].text, cx = x, cy = y;
            // box 高度自适应
...
var WorkerEditor = /** @class */ (function () {
    ...
    WorkerEditor.prototype._cerateToolBar = function () {
        ...
        this.toolbarCtrl = new _ToolBar__WEBPACK_IMPORTED_MODULE_3__["default"](this.config);
        // 事件绑定处理
        ...
        _util__WEBPACK_IMPORTED_MODULE_2__["Util"].each(tBodyNds, function (key, nd) {
            ...
            btarget.drag(function (dx, dy) {
                ...
                var _b = $this.config.dom.get(0), offsetLeft = _b.offsetLeft, offsetTop = _b.offsetTop;
 ...
 * Joshua Conero
 */
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! raphael */ "raphael"), __webpack_require__(/*! ./WorkerEditor */ "./src/WorkerEditor.ts")], __WEBPACK_AMD_DEFINE_RESULT__ = (function (Raphael, WorkerEditor) {
...
module.exports = __WEBPACK_EXTERNAL_MODULE_raphael__;
